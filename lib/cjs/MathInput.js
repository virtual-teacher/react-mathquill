...
const TexButtons_1 = __importDefault(require("./TexButtons"));
class MathInput extends react_1.default.Component {
    constructor() {
        ...
        this.handleMouseDown = (event) => {
            var _a;
            const focused = (_a = react_dom_1.default.findDOMNode(this)) === null || _a === void 0 ? void 0 : _a.contains(event.target); // eslint-disable-line
        ...
        this.mathField = (options) => {
            ...
            return MQ.MathField(react_dom_1.default.findDOMNode(this.mathinputRef.current), options); // eslint-disable-line
        };
    ...
    render() {
        ...
        if (this.shouldShowButtons()) {
            buttons = jsx_runtime_1.jsx(TexButtons_1.default, { sets: buttonSets, onInsert: this.insert }, void 0);
        }
        return (jsx_runtime_1.jsxs("div", Object.assign({ style: { display: "inline-block", width: "100%" } }, { children: [jsx_runtime_1.jsx("div", Object.assign({ style: { display: "inline-block", width: "100%" } }, { children: jsx_runtime_1.jsx("span", { ref: this.mathinputRef, className: className, "aria-label": this.labelText, onFocus: this.handleFocus, onBlur: this.handleBlur }, void 0) }), void 0),
                jsx_runtime_1.jsx("div", Object.assign({ style: { position: "relative" } }, { children: buttons }), void 0)] }), void 0));
    }
}
