...
class MathInput extends React.Component {
    ...
    render() {
        ...
        return (_jsx("div", Object.assign({ style: { display: "inline-block", width: "100%" } }, { children: _jsx("div", Object.assign({ style: { display: "inline-block", width: "100%" } }, { children: _jsx("span", { ref: this.mathinputRef, className: className, "aria-label": (_a = this.props) === null || _a === void 0 ? void 0 : _a.label, style: ((_b = this.props) === null || _b === void 0 ? void 0 : _b.style) || {}, onFocus: this.handleFocus, onBlur: this.handleBlur }, void 0) }), void 0) }), void 0));
    }
}
