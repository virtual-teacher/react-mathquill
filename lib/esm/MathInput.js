...
class MathInput extends React.Component {
    ...
    render() {
        ...
        return (_jsxs("div", Object.assign({ style: { display: "inline-block" } }, { children: [_jsx("div", Object.assign({ style: { display: "inline-block" } }, { children: _jsx("span", { ref: this.mathinputRef, className: className, "aria-label": this.labelText, onFocus: this.handleFocus, onBlur: this.handleBlur }, void 0) }), void 0),
