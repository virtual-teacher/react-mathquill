...
class MathInput extends react_1.default.Component {
    ...
    render() {
        ...
        return (jsx_runtime_1.jsx("div", Object.assign({ style: { display: "inline-block", width: "100%" } }, { children: jsx_runtime_1.jsx("div", Object.assign({ style: { display: "inline-block", width: "100%" } }, { children: jsx_runtime_1.jsx("span", { ref: this.mathinputRef, className: className, "aria-label": (_a = this.props) === null || _a === void 0 ? void 0 : _a.label, style: ((_b = this.props) === null || _b === void 0 ? void 0 : _b.style) || {}, onFocus: this.handleFocus, onBlur: this.handleBlur }, void 0) }), void 0) }), void 0));
    }
}
